...
Plugin URI: http://designer.alor-nishan.com/wpplugin
Description: Random Al-Quran Sura
Author: Jabed Bhuiyan
Version: 2.1
Author URI: http://designer.alor-nishan.com/
*/
...
$returned_content = get_data('http://books.alor-nishan.com/quran.php'); 
...
function bdalquran_handler() {
  $ch = curl_init();
  $timeout = 5;
  curl_setopt($ch, CURLOPT_URL, 'http://books.alor-nishan.com/quran.php');
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, $timeout);
  $data = curl_exec($ch);
  curl_close($ch);
